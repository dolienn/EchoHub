...
export class MessageService extends BaseService {
  ...
  static readonly SetMessagesToSeenPath = '/messages';
  ...
  static readonly UploadMediaPath = '/messages/upload-file';
  ...
  static readonly GetMessagesPath = '/messages/chat/{chat-id}';
